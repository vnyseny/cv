...
\section{\textbf{Technical Skills}}
 \begin{itemize}[leftmargin=0.1in, label={}]
    \small{\item{
     \textbf{Languages}{: C\#, Javascript, Java, Python, SQL, HTML, XML} \\
     \textbf{Developer Tools}{: Visual Studio, VS Code, Git, Github } \\
     \textbf{Frameworks/Libraries}{: ASP.NET, .NET(Dotnet), ReactJs, MVC, MVVM, Blazor, Bootstrap, JQuery, Entity Framework, LINQ, Serilog, OpenXML } \\
     ...
     \textbf{Other Skills}{: Azure DevOps, Linux, REST API, WCF, WPF} \\
